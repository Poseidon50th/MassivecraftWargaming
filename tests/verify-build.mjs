...
assert.match(singlePlayerHtml, /v0\.7\.1/, "the built single-player page must identify v0.7.1");
assert.match(multiplayerHtml, /v0\.7\.1/, "the built multiplayer page must identify v0.7.1");
