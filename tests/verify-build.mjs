...
assert.match(singlePlayerHtml, /v0\.7\.2/, "the built single-player page must identify v0.7.2");
assert.match(multiplayerHtml, /v0\.7\.2/, "the built multiplayer page must identify v0.7.2");
