...
Massivecraft’s Wars v0.7.1 keeps the game itself on GitHub Pages while adding an authoritative, quota-hardened two-player service. The service keeps orders secret, enforces the existing rules, survives a browser refresh, and protects ongoing matches from exhausting the free allowance through wasteful transport or room spam.
