...
export function evaluatePosition(game, perspective, baseline, difficultyId) {
  ...
  if (difficultyId === "corporal") {
    let score = feature.enemyLost * 150 + feature.ownLost * 38 + feature.mutualLosses * 70
      ...
      - feature.ownSupport * 2 - feature.ownTerrain * 10 + feature.ownIsolation * 5
  ...
  if (difficultyId === "general") {
    ...
    let score = feature.enemyLost * (greedy ? 245 : 190) - feature.ownLost * (greedy ? 120 : 205)
      ...
      - feature.enemyPressureOnOwnUnits * (greedy ? 5 : 9)
      - feature.ownExposureConcentration * (greedy ? 1.2 : 2) - feature.ownUnitsContested * 45
  ...
  let score = feature.enemyLost * 340 - feature.ownLost * 1150
    ...
    + feature.ownProgress * 12 + feature.ownBeyondHome * 82 - feature.ownHomebound * 52
    + feature.ownPressureCells * 11 + feature.ownEnemyHomeControl * 24
    + feature.ownPressureOnEnemyUnits * 28 + feature.enemyUnitsContested * 190
    - feature.ownEnemyDistance * 13 + feature.ownContactUnits * 55 - feature.ownPassedUnengaged * 130
    + feature.enemyPressureConcentration * 8 + feature.bestEnemyBreachMargin * 85
